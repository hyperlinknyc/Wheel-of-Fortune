...
export const DAYS = [
  {
    ...
    minutes: 14,
    blocks: [B(bonusCategory, 8), B(bonusSim, 2), B(solveOrSpin, 5), B(vowelDrill, 5), B(tossUp, 4)],
  },
  {
    n: 2,
    ...
    minutes: 13,
    blocks: [B(solveOrSpin, 7), B(vowelDrill, 7), B(solveOrSpin, 6), B(vowelNameDrill, 5)],
  },
  {
    n: 3,
    ...
    minutes: 13,
    blocks: [B(nameShape, 4), B(soundItOut, 5), B(vowelNameDrill, 6), B(nameShape, 4), B(soundItOut, 4)],
  },
  {
    n: 4,
    ...
    minutes: 14,
    blocks: [B(attentionLoop, 2), B(tossUp, 7), B(attentionLoop, 2), B(tossUp, 6)],
  },
  {
    n: 5,
    ...
    minutes: 15,
    blocks: [B(nameShape, 4), B(soundItOut, 5), B(bonusLetters, 6), B(bonusCategory, 8), B(solveOrSpin, 5)],
  },
  {
    n: 6,
    theme: 'Full dress',
    ...
    minutes: 15,
    blocks: [B(bonusSim, 3), B(tossUp, 6), B(fullGameSim, 6), B(sayItExactly, 4)],
  },
  {
    n: 7,
    theme: 'Taper — light, no new material',
    blurb: 'Easy category reps, clean articulation, and the cheat sheet out loud.',
    minutes: 11,
    blocks: [B(bonusCategory, 6), B(sayItExactly, 4), B(cheatRecital, 8)],
  },
];
